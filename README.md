...
Instructions to run the CPU that we built and the program that plays bad apple and Kaiju. To play your own short tune, use program/tune/tune.py to generate your own short tune.
